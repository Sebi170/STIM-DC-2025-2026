...
@Autonomous(name = "Albastru_auto_departe", group = "Examples")
public class Auto_albastru_departe extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                double voutake = motor3.getVelocity();
                motor3.setPower(getCompensatedPower(-0.52));
                motor4.setPower(getCompensatedPower(0.52));
