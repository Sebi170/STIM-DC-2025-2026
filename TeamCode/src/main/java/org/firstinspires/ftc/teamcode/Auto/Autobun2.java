...
@Autonomous(name = "Rosu iesirem", group = "Auto")
public class Autobun2 extends OpMode {
    ...
    private final Pose scorePose = new Pose(0, 20, Math.toRadians(0)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
