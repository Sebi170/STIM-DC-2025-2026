...
@Autonomous(name = "Albastru iesire", group = "Auto")
public class Autobun extends OpMode {
    ...
    private final Pose startPose = new Pose(-44, -116, Math.toRadians(45)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(11, -70, Math.toRadians(45)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 8:
                telemetry.addLine("babab");
                motor1.setPower(-0.9);
                motor2.setPower(0.9);
                double voutake = motor3.getVelocity();
                motor3.setPower(getCompensatedPower(baseAdjust(-0.52, voutake, -1280)));
                motor4.setPower(getCompensatedPower(baseAdjust(-0.52, voutake, -1280)));
                break;
            case 1:
